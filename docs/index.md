...
Or manually: open **HACS → Integrations**, three-dot menu → **Custom repositories** → paste this repository URL → category **Integration** → click **Install** and restart Home Assistant.
